class WindowsController < ApplicationController
  ...
  private
    ...
    def window_params
      params.require(:window).permit(:object_name, :area, :glass, :dev_proj_ratio, :aspect_ratio, :frame_factor, :shading_position, :shading_colour, :shading_translucency, :shading_factor, :brise_soleil, :disp_wind, :multiplier, :roof_light_cover)
    end
end
