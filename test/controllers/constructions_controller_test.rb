...
class ConstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create construction" do
    assert_difference('Construction.count') do
      post constructions_url, params: { construction: { cm: @construction.cm, metal_cladding: @construction.metal_cladding, object_name: @construction.object_name, type_0: @construction.type_0, u_value: @construction.u_value, u_value_corr: @construction.u_value_corr } }
    end
  ...
  test "should update construction" do
    patch construction_url(@construction), params: { construction: { cm: @construction.cm, metal_cladding: @construction.metal_cladding, object_name: @construction.object_name, type_0: @construction.type_0, u_value: @construction.u_value, u_value_corr: @construction.u_value_corr } }
